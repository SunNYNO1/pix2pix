...
def create_generator(input_img,output_channels):
    #***encoder***    
    conv1 = tf.layers.conv2d(input_img, 64, kernel_size = 4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    lrelu1 = tf.nn.leaky_relu(conv1,alpha=0.2)
    
    conv2 = tf.layers.conv2d(lrelu1, 64*2, kernel_size = 4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    ...
    conv3 = tf.layers.conv2d(lrelu2, 64*4, kernel_size=4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    ...
    conv4 = tf.layers.conv2d(lrelu3, 64*8, kernel_size=4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    ...
    conv5 = tf.layers.conv2d(lrelu4, 64*8, kernel_size=4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    ...
    conv6 = tf.layers.conv2d(lrelu5, 64*8, kernel_size=4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    ...
    conv7 = tf.layers.conv2d(lrelu6, 64*8, kernel_size=4, strides=(2,2), padding='SAME', kernel_initializer=tf.random_normal_initializer(0, 0.02))
    ...
    deconcat5 = tf.concat([denorm4,norm4],axis=3)
    ...
    deconcat6 = tf.concat([denorm5,norm3],axis=3)
    ...
    deconcat7 = tf.concat([denorm6,norm2],axis=3)
    ...
    deconcat8 = tf.concat([denorm7,lrelu1],axis=3)
